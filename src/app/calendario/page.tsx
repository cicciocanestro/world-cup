  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-4 md:py-6">
      <div className="mb-5 md:mb-6 flex flex-col sm:flex-row items-start sm:items-end justify-between gap-2">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-white mb-1">Calendario</h1>
          <p className="text-gray-400 text-xs md:text-sm">Tutte le partite ancora da giocare</p>
        </div>
